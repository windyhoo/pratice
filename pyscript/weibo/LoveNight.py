...
#http://lovenight.github.io/2015/11/23/Python-%E6%A8%A1%E6%8B%9F%E7%99%BB%E5%BD%95%E6%96%B0%E6%B5%AA%E5%BE%AE%E5%8D%9A/index.html
import configparser
import sys
import os
import requests
...
class WeiboUtil(object):
    ...
    def getTimeline(self, max_id=0, count=10, page=1, feature=0):
        """读取时间线上的微博
    ...
    def getBilateralTimeline(self, max_id=0, count=10, page=1, feature=0):
        """获取互相关注好友的时间线
